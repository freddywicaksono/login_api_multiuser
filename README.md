...
#### 2. Folder API yang digunakan : appakademk
#### 3. Alamat API yang digunakan : http://localhost/appakademik/users_api.php
#### 4. Folder Client API yang digunakan : apiclient
#### 5. Import tabel user (users.sql)
